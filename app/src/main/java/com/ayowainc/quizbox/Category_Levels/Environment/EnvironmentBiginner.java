...
public class EnvironmentBiginner extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new questionsModelClass("Ecology and Environmental Science are under...","Botany","Biology","Environmental Studies","Chemistry","Environmental Studies"));
        list.add(new questionsModelClass("Deforestation and Global Warming are:","Natural disasters","Environmental issues","Geological phenomena","Human achievements","Environmental issues"));
        list.add(new questionsModelClass("Renewable energy sources include:", "Coal and oil","Nuclear power","Solar and wind energy","Natural gas","Solar and wind energy"));
        list.add(new questionsModelClass("Biodiversity refers to:","The variety of life on Earth","Population growth rate","Extinct species count", "Environmental temperature","The variety of life on Earth"));
        list.add(new questionsModelClass("Ozone depletion primarily affects the:", "Stratosphere", "Troposphere", "Mesosphere","Exosphere", "Stratosphere"));
        list.add(new questionsModelClass("Biodegradable materials:","Decompose naturally", "Persist indefinitely","Only break down with human help", "Cause pollution","Decompose naturally"));
        list.add(new questionsModelClass("Eutrophication is caused by excess:","Oxygen","Nitrogen and phosphorus","Carbon dioxide", "Heavy metals","Nitrogen and phosphorus"));
        list.add(new questionsModelClass("Greenhouse gases trap heat, causing:", "Global cooling", "Acid rain", "Ozone depletion", "Global warming","Global warming"));
        list.add(new questionsModelClass("Sustainable development aims to:", "Meet present needs without harming the future","Prioritize economic growth over environment", "Address immediate needs only","Increase resource consumption","Meet present needs without harming the future"));
        list.add(new questionsModelClass("Environmental Impact Assessment (EIA) evaluates:","Economic impacts", "Environmental consequences","Political implications","Wildlife populations", "Environmental consequences"));
...
//                        share = result.findViewById(R.id.share_btn);
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), EnvironmentBiginner.class); //If User get 20% let him or her play again
                                startActivity(BG);
                            }
                        });
...
//                        share = result.findViewById(R.id.share_btn);
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), EnvironmentBiginner.class); ///If User get 50% let him or her play again
                                startActivity(BG);
                            }
                        });
...
//                        share = result.findViewById(R.id.share_btn);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (menuItem.getItemId() == R.id.home) {
            ...
            startActivity(home);
            EnvironmentBiginner.super.onBackPressed();
