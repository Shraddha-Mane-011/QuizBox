...
public class ScienceBiginner extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//    private InterstitialAd mInterstitialAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new questionsModelClass("Which of the following is not a vector quantity?", "Force", "Distance", "Velocity", "Acceleration", "Distance"));
        list.add(new questionsModelClass("The SI unit of electric charge is:", "Coulomb", "Ampere", "Ohm ", "Volt", "Coulomb"));
        list.add(new questionsModelClass("What is the SI unit of energy?", "Newton", "Joule", "Watt", "Ohm", "Joule"));
        list.add(new questionsModelClass(" When an object is placed in water, which force opposes its motion?", "Gravitational force", "Frictional force", "Buoyant force", "Tension Force", "Buoyant force"));
        list.add(new questionsModelClass("The property of a body to resist a change in its state of motion is known as:", "Inertia", "Momentum", "Friction", "Acceleration", "Inertia"));
        list.add(new questionsModelClass("What is the speed of light in vacuum?","300,000 km/s","299,792,458 m/s"," 3 x 10^8 m/s","186,282 miles/s","299,792,458 m/s"));
        list.add(new questionsModelClass("Which of the following is not a type of mechanical wave?","Sound wave","Light wave", "Water wave" ,"Seismic wave","Light wave"));
        list.add(new questionsModelClass("The phenomenon of bending of light when it passes from one medium to another is called:","Reflection","Refraction", "Diffraction" ,"Dispersion","Refraction"));
        list.add(new questionsModelClass("Which of the following is not a fundamental force in nature?","Gravitational force", "Electromagnetic force" ,"Strong nuclear force" ,"Weak nuclear force","Weak nuclear force"));
        list.add(new questionsModelClass("The rate of change of momentum of an object is equal to the:","Force acting on it","Acceleration of the object", "Mass of the object" ,"Impulse exerted on it","Force acting on it"));
                ...
                if (position == list.size()) {
                    ...
                    if (score <= 2) {
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), ScienceBiginner.class); //If User get 20% let him or her play again
                                startActivity(BG);
                            }
                        });
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), ScienceBiginner.class); ///If User get 50% let him or her play again
                                startActivity(BG);
                            }
                        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (menuItem.getItemId() == R.id.home) {
            ...
            startActivity(home);
            ScienceBiginner.super.onBackPressed();
