...
public class ScienceWorldClass extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new questionsModelClass("Which of the following is not a state of matter?", "Solid" ,"Liquid" ,"Gas" ,"Energy","Energy"));
        list.add(new questionsModelClass( "The process of decomposition of a compound by passing electric current through it is called:" ,"Combustion", "Electrolysis" ,"Sublimation" ,"Dissociation","Electrolysis"));
        list.add(new questionsModelClass( "What is the chemical formula for hydrogen peroxide?" ,"H2O2" ,"HO" ,"H2O" ,"H3O","H2O2"));
        list.add(new questionsModelClass("Which of the following is not an alkali metal?","Sodium" ,"Potassium" ,"Calcium" ,"Lithium","Calcium"));
        list.add(new questionsModelClass("The process of conversion of a liquid into a gas is called:" ,"Condensation" ,"Vaporization" ,"Sublimation" ,"Evaporation","Evaporation"));
        list.add(new questionsModelClass("The molecular formula of glucose is:" ,"C6H12O6" ,"CO2" ,"CH4" ,"C2H6O","C6H12O6"));
        list.add(new questionsModelClass( "What is the chemical formula for sulfuric acid?" ,"H2SO4" ,"HCl" ,"HNO3" ,"NaOH","H2SO4"));
        list.add(new questionsModelClass("The SI unit of power is:" ,"Joule" ,"Newton" ,"Watt" ,"Volt" ,"Watt"));
        ...
        list.add(new questionsModelClass(   "What is the SI unit of force?" ,"Newton" ,"Watt" ,"Joule" ,"Pascal" ,"Newton"));
        list.add(new questionsModelClass("Which of the following is a vector quantity?" ,"Mass" ,"Temperature" ,"Distance" ,"Velocity" ,"Velocity"));
        list.add(new questionsModelClass( "Which law states that for every action, there is an equal and opposite reaction?" ,"Newton's first law" ,"Newton's second law" ,"Newton's third law" ,"Newton's law of gravitation" ,"Newton's third law"));
        list.add(new questionsModelClass("What is the SI unit of pressure?" ,"Pascal","Newton" ,"Joule" ,"Watt" ,"Pascal"));
        list.add(new questionsModelClass( "Which of the following is a renewable source of energy?" ,"Coal" ,"Natural gas" ,"Solar" ,"Petroleum" ,"Solar"));
        list.add(new questionsModelClass("What is the chemical symbol for gold?" ,"Au" ,"Ag" ,"Fe" ,"Cu","Au"));
        list.add(new questionsModelClass("What is the chemical formula for table salt?" ,"NaCl" ,"HCl" ,"NaOH" ,"NH4Cl","NaCl"));
        list.add(new questionsModelClass("What is the SI unit of temperature?" ,"Kelvin" ,"Celsius" ,"Fahrenheit" ,"Joule" ,"Kelvin"));
        list.add(new questionsModelClass(  "Which of the following elements is a noble gas?" ,"Neon" ,"Sodium" ,"Oxygen" ,"Nitrogen","Neon"));
        list.add(new questionsModelClass(  "What is the chemical formula for water?" ,"H2O" ,"CO2" ,"NaCl" ,"CH4","H2O"));
        list.add(new questionsModelClass("What is the SI unit of force?","Newton", "Watt","Joule","Pascal","Newton" ));
        list.add(new questionsModelClass( "Which of the following is a vector quantity?","Mass" ,"Temperature","Distance" ,"Velocity","Velocity"));
        list.add(new questionsModelClass("Which law states that every object persists in its state of rest or uniform motion unless acted upon by an external force?" ,"Newton's first law of motion" ,"Newton's second law of motion" ,"Newton's third law of motion" ,"Newton's law of gravitation","Newton's first law of motion"));
        list.add(new questionsModelClass( "What is the acceleration due to gravity on the surface of the Earth?" ,"10 m/s^2" ,"9.8 m/s^2" ,"5.2 m/s^2" ,"7.3 m/s^2" ,"9.8 m/s^2"));
        list.add(new questionsModelClass(   "What is the chemical symbol for potassium?" ,"K" ,"P" ,"Pt" ,"Ka","K"));
        list.add(new questionsModelClass("What is the chemical formula for sulfuric acid?" ,"H2SO4" ,"HCl" ,"HNO3" ,"NaOH" ,"H2SO4"));
        list.add(new questionsModelClass("Which of the following is a metalloid?" ,"Silicon" ,"Sodium" ,"Silver" ,"Sulfur" ,"Silicon"));
        list.add(new questionsModelClass("Which of the following is a non-renewable source of energy?" ,"Solar energy" ,"Wind energy" ,"Coal" ,"Hydroelectric energy" ,"Coal"));
        list.add(new questionsModelClass("What is the SI unit of electric charge?" ,"Coulomb" ,"Ampere" ,"Ohm" ,"Volt" ,"Coulomb"));
        list.add(new questionsModelClass("Which of the following statements about the conservation of momentum is true?" ,"Momentum is always conserved in collisions between objects." ,"Momentum is conserved only in elastic collisions." ,"Momentum is conserved only in inelastic collisions." ,"Momentum is conserved only in perfectly elastic collisions." ,"Momentum is always conserved in collisions between objects."));
...
//                        share = dialog.findViewById(R.id.share_btn);
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), ScienceWorldClass.class); //If User get 20% let him or her play again
                                startActivity(BG);
                            }
                        });
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), ScienceWorldClass.class); ///If User get 50% let him or her play again
                                startActivity(BG);
                            }
                        });
                        Objects.requireNonNull(dialog.getWindow()).setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (menuItem.getItemId() == R.id.home) {
            ...
            startActivity(home);
            ScienceWorldClass.super.onBackPressed();
