...
public class AJPBiginner extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new questionsModelClass( "Which Swing component is used to display a single line of editable text?" ,"JTextArea" ,"JTextField" ,"JTextPane" ,"JLabel","JTextField"));
        list.add(new questionsModelClass( "Which layout manager is suitable for arranging components in a grid-like fashion with rows and columns?" ,"BorderLayout" ,"FlowLayout" ,"GridLayout" ,"GridBagLayout" ,"GridLayout"));
        list.add(new questionsModelClass("What colour is vermilion a shade of", "red", "green", "blue", "yellow", "red"));
        list.add(new questionsModelClass("Which Swing component is used to display a list of selectable items?" ,"JList" ,"JComboBox" ,"JTable" ,"JCheckBox" ,"JList"));
        list.add(new questionsModelClass("Which method is used to add a component to a container in Java Swing?" ,"add()" ,"append()" ,"insert()" ,"attach()" ,"add()"));
        list.add(new questionsModelClass("Which class is used to create a window in Java Swing?" ,"JFrame" ,"JPanel" ,"JWindow" ,"JDialog" ,"JFrame"));
        list.add(new questionsModelClass("What is the purpose of the GridBagConstraints class in Java Swing?" ,"To specify constraints for components in a BorderLayout" ,"To specify constraints for components in a GridLayout" ,"To specify constraints for components in a FlowLayout" ,"To specify constraints for components in a GridBagLayout" ,"To specify constraints for components in a GridBagLayout"));
        list.add(new questionsModelClass("Which Swing component is used to create a group of radio buttons?" ,"JRadioButtonGroup" ,"JRadioGroup" ,"JRadioButtonPanel" ,"ButtonGroup" ,"ButtonGroup"));
        list.add(new questionsModelClass( "What is the purpose of the setLayout() method in Java Swing?" ,"To set the layout manager for a container" ,"To set the layout manager for a component" ,"To set the layout manager for a frame" ,"To set the layout manager for a window" ,"To set the layout manager for a container"));
        list.add(new questionsModelClass("Which method is used to set the title of a JFrame in Java Swing?" ,"setTitle()" ,"setCaption()" ,"setLabel()" ,"setHeader()" ,"setTitle()"));
...
//                        share = result.findViewById(R.id.share_btn);
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), AJPBiginner.class); //If User get 20% let him or her play again
                                startActivity(BG);
                            }
                        });
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), AJPBiginner.class); ///If User get 50% let him or her play again
                                startActivity(BG);
                            }
                        });
...
//                        share = result.findViewById(R.id.share_btn);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (menuItem.getItemId() == R.id.home) {
            ...
            startActivity(home);
            AJPBiginner.super.onBackPressed();
