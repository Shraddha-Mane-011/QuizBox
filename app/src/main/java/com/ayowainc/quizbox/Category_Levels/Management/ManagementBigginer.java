...
public class ManagementBigginer extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new questionsModelClass("Which of the following is not a function of management?","Planning","Organizing","Controlling","Executing","Executing"));
        list.add(new questionsModelClass( "The process of setting objectives and determining the course of action to achieve them is known as:","Controlling","Organizing","Leading","Planning","Planning"));
        list.add(new questionsModelClass("Which of the following is not a characteristic of effective communication?","Clarity","Timeliness","Complexity","Feedback","Complexity"));
        list.add(new questionsModelClass( "Which of the following is not a type of leadership style?","Autocratic","Democratic","Laissez-faire","Authoritarian","Authoritarian"));
        list.add(new questionsModelClass( "SWOT analysis stands for:","Strengths, Weaknesses, Opportunities, Threats","Strategies, Weaknesses, Opportunities, Threats","Strengths, Weaknesses, Objectives, Tactics","Strategies, Weaknesses, Objectives, Tactics","Strengths, Weaknesses, Opportunities, Threats"));
        list.add(new questionsModelClass("Which of the following is not a part of Maslow's hierarchy of needs?","Esteem needs","Belongingness needs","Security needs","Survival needs","Survival needs"));
        list.add(new questionsModelClass("Which of the following is not a factor affecting span of management?","Employee skills and abilities","Complexity of tasks","Organizational structure","Time management","Time management"));
        list.add(new questionsModelClass("Which of the following is not a component of Total Quality Management (TQM)?","Continuous improvement","Customer focus","Centralization","Employee involvement","Centralization"));
        list.add(new questionsModelClass("Which of the following is not a step in the decision-making process?","Implementing the decision","Identifying alternatives","Skipping evaluation","Evaluating alternatives","Skipping evaluation"));
        list.add(new questionsModelClass("Which of the following is not a type of organizational structure?","Functional","Matrix","Hierarchical","Entrepreneurial","Entrepreneurial"));
                ...
                if (position == list.size()) {
                    ...
                    if (score <= 2) {
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), ManagementBigginer.class); //If User get 20% let him or her play again
                                startActivity(BG);
                            }
                        });
...
//                        share = dialog.findViewById(R.id.share_btn);
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), ManagementBigginer.class); ///If User get 50% let him or her play again
                                startActivity(BG);
                            }
                        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (menuItem.getItemId() == R.id.home) {
            ...
            startActivity(home);
            ManagementBigginer.super.onBackPressed();
